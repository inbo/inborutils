...
The Dutch meteoroligcal institute, KNMI, provides a webservice to query and download data. [This tutorial](https://www.knmi.nl/kennis-en-datacentrum/achtergrond/data-ophalen-vanuit-een-script) provides more information about their service.
...
To read the data and provide it into a similar format as the previous time series, the function `load_kmi_data` is available in the `inborutils` package:
