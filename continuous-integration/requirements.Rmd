...
- integration of github webhooks (e.g. start build html service on push, automatic builds)
- bij pull requests,... buiilden en interactie met github: voorzien van feedback binnen github-omgeving (via badges, etc...) 
- Ondersteuning java
- Omgaan met bash-script gewijs geschreven 
- Ondersteuning van .NET applicaties (ANB)
